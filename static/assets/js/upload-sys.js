...
UPLOADCARE_PUBLIC_KEY = '8a7360c31740f18c8456'; //my personal uploadcare key
UPLOADCARE_IMAGES_ONLY = true; //upload only pictures
UPLOADCARE_SYSTEM_DIALOG = true; //create a system dialog when upload button is clicked
PREVIEW_URL = "";
CURRENT_ROTATION = 0;
BASE_URL = "";
SET_PROFILE_PIC = false; //determine whether its a profile pic or not

//function taken from uploadcare website, allow preview of uploaded picture and edit it
...
//uploadcare code allowing preview
$(function() {
